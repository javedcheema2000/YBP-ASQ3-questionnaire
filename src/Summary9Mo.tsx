...
import { ASQ_DATA } from './data';

const ASQ_9_MO_SCORING = [
...
export function Summary9Mo({ submission, onSectionClick }: { submission: Submission; onSectionClick?: (sectionKey: string) => void }) {
  ...
  const computeScore = (prefix: string) => {
    ...
    let answered = 0;
    for (let i = 1; i <= 6; i++) {
      const val = answers[`9_${prefix}_${i}`];
  ...
  const scores = ASQ_9_MO_SCORING.map(row => {
    return {
      ...row,
    ...
    <div className="font-sans text-black max-w-5xl mx-auto space-y-8 print:space-y-3 print:w-[800px] text-sm print:text-[11px] print:leading-snug">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 print:gap-x-4 print:gap-y-0.5 print:grid-cols-2">
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_1', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_1', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['9_o_1_explain'] && (
            <div className={getOverallExplainClass('9_o_1', getOverallVal('9_o_1') === 'NO')}>
              {answers['9_o_1_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>5.</span> Concerns about vision?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_5', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_5', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_5_explain'] && (
            <div className={getOverallExplainClass('9_o_5', getOverallVal('9_o_5') === 'YES')}>
              {answers['9_o_5_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>2.</span> Feet are flat on the surface most of the time?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_2', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_2', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['9_o_2_explain'] && (
            <div className={getOverallExplainClass('9_o_2', getOverallVal('9_o_2') === 'NO')}>
              {answers['9_o_2_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>6.</span> Any medical problems?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_6', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_6', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_6_explain'] && (
            <div className={getOverallExplainClass('9_o_6', getOverallVal('9_o_6') === 'YES')}>
              {answers['9_o_6_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>3.</span> Concerns about not making sounds?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_3', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_3', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_3_explain'] && (
            <div className={getOverallExplainClass('9_o_3', getOverallVal('9_o_3') === 'YES')}>
              {answers['9_o_3_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>7.</span> Concerns about behavior?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_7', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_7', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_7_explain'] && (
            <div className={getOverallExplainClass('9_o_7', getOverallVal('9_o_7') === 'YES')}>
              {answers['9_o_7_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>4.</span> Family history of hearing impairment?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_4', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_4', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_4_explain'] && (
            <div className={getOverallExplainClass('9_o_4', getOverallVal('9_o_4') === 'YES')}>
              {answers['9_o_4_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              <span className="flex gap-2"><span>8.</span> Other concerns?</span>
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_8', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('9_o_8', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['9_o_8_explain'] && (
            <div className={getOverallExplainClass('9_o_8', getOverallVal('9_o_8') === 'YES')}>
              {answers['9_o_8_explain']}
            </div>
          )}
          </div>
            ...
            <tbody>
              {scores.map(row => (
                <tr key={row.key} className="border-b border-black last:border-0">
                  ...
                  {[1, 2, 3, 4, 5, 6].map(i => {
                    const ans = answers[`9_${row.key}_${i}`];
