...
export function Summary36Mo({ submission, onSectionClick }: { submission: Submission; onSectionClick?: (sectionKey: string) => void }) {
  ...
  const computeScore = (prefix: string) => {
    ...
    let answered = 0;
    for (let i = 1; i <= 6; i++) {
      const val = answers[`36_${prefix}_${i}`];
  ...
  const scores = ASQ_36_MO_SCORING.map(row => {
    return {
      ...row,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 print:gap-x-4 print:gap-y-0.5 print:grid-cols-2">
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_1', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_1', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['36_o_1_explain'] && (
            <div className={getOverallExplainClass('36_o_1', getOverallVal('36_o_1') === 'NO')}>
              {answers['36_o_1_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_6', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_6', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['36_o_6_explain'] && (
            <div className={getOverallExplainClass('36_o_6', getOverallVal('36_o_6') === 'YES')}>
              {answers['36_o_6_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_2', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_2', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['36_o_2_explain'] && (
            <div className={getOverallExplainClass('36_o_2', getOverallVal('36_o_2') === 'NO')}>
              {answers['36_o_2_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_7', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_7', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['36_o_7_explain'] && (
            <div className={getOverallExplainClass('36_o_7', getOverallVal('36_o_7') === 'YES')}>
              {answers['36_o_7_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_3', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_3', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['36_o_3_explain'] && (
            <div className={getOverallExplainClass('36_o_3', getOverallVal('36_o_3') === 'NO')}>
              {answers['36_o_3_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_8', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_8', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['36_o_8_explain'] && (
            <div className={getOverallExplainClass('36_o_8', getOverallVal('36_o_8') === 'YES')}>
              {answers['36_o_8_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_4', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_4', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['36_o_4_explain'] && (
            <div className={getOverallExplainClass('36_o_4', getOverallVal('36_o_4') === 'NO')}>
              {answers['36_o_4_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_9', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_9', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['36_o_9_explain'] && (
            <div className={getOverallExplainClass('36_o_9', getOverallVal('36_o_9') === 'YES')}>
              {answers['36_o_9_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_5', 'YES', false)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_5', 'NO', true)}`}>No</span>
              </span>
            </div>
            {answers['36_o_5_explain'] && (
            <div className={getOverallExplainClass('36_o_5', getOverallVal('36_o_5') === 'NO')}>
              {answers['36_o_5_explain']}
            </div>
          )}
          </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-start gap-2">
              ...
              <span className="shrink-0 space-x-2 font-medium flex items-center">
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_10', 'YES', true)}`}>Yes</span>
                <span className={`px-1.5 py-0.5 ${getOverallBadgeClass('36_o_10', 'NO', false)}`}>No</span>
              </span>
            </div>
            {answers['36_o_10_explain'] && (
            <div className={getOverallExplainClass('36_o_10', getOverallVal('36_o_10') === 'YES')}>
              {answers['36_o_10_explain']}
            </div>
          )}
          </div>
            ...
            <tbody>
              {scores.map(row => (
                <tr key={row.key} className="border-b border-black last:border-0">
                  ...
                  {[1, 2, 3, 4, 5, 6].map(i => {
                    const ans = answers[`36_${row.key}_${i}`];
